...
## Project Structure
    ...
    ├── testapiautoteammemb_68182  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_68182`
...
2. Clone this repo and `cd testapiautoteammemb_68182`
